...
const seedProducts = [
  { product_id: 1, sku: 'TR-0001', barcode: '8855100000001', product_name: 'Hoodie Basic', price: 69.99, discount: 43, stock: 34, size: 'M', color: 'Beige', material: 'Cotton/Polyester Blend', description: 'This hoodie is crafted from a premium blend of cotton and polyester for unmatched comfort and durability.', image: '/images/Uniqlo/usgoods_64_465185_3x4.avif', category_id: 2, brand_id: 6 },
  ...
  { product_id: 13, sku: 'TR-0013', barcode: '8855100000013', product_name: 'Cargo Pant', price: 54.99, discount: 0, stock: 18, size: 'L', color: 'Black', material: 'Cotton Twill', description: 'Utility cargo pants with multiple pockets and a tapered fit.', image: '/images/Nike/M+NK+CLUB+WVN+CARGO+PANT+CLCTN.avif', category_id: 8, brand_id: 2 },
  { product_id: 14, sku: 'TR-0014', barcode: '8855100000014', product_name: 'Short Pant', price: 27.99, discount: 0, stock: 26, size: 'M', color: 'Navy', material: 'Cotton Blend', description: 'Casual shorts for warm-weather comfort.', image: "/images/Puma/WARDROBE-ESSENTIALS-Men's-Relaxed-6_-Cargo-Shorts.avif", category_id: 3, brand_id: 4 },
